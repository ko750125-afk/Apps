    ...
    <nav className="sticky top-0 z-50 w-full bg-black/40 backdrop-blur-2xl border-b border-neutral-900 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          ...
          <span className="text-sm font-semibold tracking-tight">쇼케이스</span>
        </button>
        ...
        <div className="flex items-center gap-3">
          {app.url && (
            <a 
              ...
              className="text-xs font-semibold text-white px-6 py-2.5 bg-blue-600 hover:bg-blue-500 rounded-xl transition-all flex items-center gap-2 shadow-lg shadow-blue-600/20 active:scale-95"
            >
              사이트 열기 <ExternalLink className="w-3.5 h-3.5" />
            </a>
          )}
        </div>
      </div>
